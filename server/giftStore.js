...
const DEFAULT_GIFTS = [
  ...
  { id: "crown",     name: "تاج",      emoji: "👑", coins: 200, rarity: "rare", priority: 2, duration: 4000, renderer: "scenario", asset: null, scenario: "crown", sound: "fanfare", sounds: { fanfare: "/sounds/fanfare.wav" }, volume: 0.7, shake: false, fullscreen: true, category: "vip" },
  ...
  { id: "fireworks",   name: "ألعاب نارية", emoji: "🎆", coins: 2000, rarity: "legendary", priority: 5, duration: 5000, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/fireworks.mp4", assetAudio: false, scenario: "fireworksShow", sound: "fireworks", sounds: { fireworks: "/sounds/fireworks_long.wav" }, volume: 0.85, shake: true, fullscreen: true, category: "gift" },
  ...
  { id: "rocket",     name: "صاروخ",      emoji: "🚀", coins: 3000,  rarity: "legendary", priority: 6, duration: 7000, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/rocket.mp4",     assetAudio: false, scenario: "rocket",    sound: "rocket",  sounds: { rocket: "/sounds/rocket.mp3", fireworks: "/sounds/fireworks_long.wav", countdown: "/sounds/pop.wav" }, volume: 0.85, shake: true, fullscreen: true, category: "gift" },
  ...
  { id: "lion",       name: "أسد",        emoji: "🦁", coins: 6000,  rarity: "legendary", priority: 6, duration: 6000, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/lion.mp4", assetAudio: false, scenario: "lion",      sound: "roar",    sounds: { roar: "/sounds/roar_big.wav", whoosh: "/sounds/whoosh.wav" }, volume: 0.9, shake: true, fullscreen: true, category: "celeb" },
  { id: "tiger",      name: "نمر",        emoji: "🐅", coins: 6500,  rarity: "legendary", priority: 6, duration: 6000, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/tiger.mp4",      assetAudio: false, scenario: "lion",      sound: "roar",    sounds: { roar: "/sounds/tiger_roar.mp3", whoosh: "/sounds/whoosh.wav" }, volume: 0.9, shake: true, fullscreen: true, category: "celeb" },
  ...
  { id: "phoenix",    name: "عنقاء",      emoji: "🦅", coins: 15000, rarity: "legendary", priority: 8, duration: 7500, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/phoenix.mp4",    assetAudio: false, scenario: "phoenix",   sound: "whoosh",  sounds: { whoosh: "/sounds/phoenix.wav" }, volume: 0.9, shake: true, fullscreen: true, category: "celeb" },
  { id: "yacht",      name: "يخت فاخر",   emoji: "🛥️", coins: 20000, rarity: "legendary", priority: 9, duration: 8000, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/yacht.mp4",      assetAudio: false, scenario: "yacht",     sound: "horn",    sounds: { horn: "/sounds/yacht_horn.wav" }, volume: 0.85, shake: true, fullscreen: true, category: "vip" },
  { id: "whale",      name: "حوت",        emoji: "🐋", coins: 30000, rarity: "legendary", priority: 9, duration: 7000, renderer: "scenario", asset: null,      scenario: "whale",     sound: "whale",   sounds: { whale: "/sounds/whale.wav" }, volume: 0.9, shake: true, fullscreen: true, category: "vip" },
  { id: "galaxy",     name: "مجرّة",      emoji: "🌌", coins: 50000, rarity: "legendary", priority: 10, duration: 8500, renderer: "video", asset: "https://github.com/zaiem1418-png/game/releases/download/gift-assets-v1/galaxy.mp4",    assetAudio: false, scenario: "galaxy",    sound: "cosmic",  sounds: { cosmic: "/sounds/cosmic.wav" }, volume: 0.9, shake: true, fullscreen: true, category: "vip" },
];
